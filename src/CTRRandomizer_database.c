...
// The Gem Cup IDs exist but they were unnamed so I named them here.
enum CupID
{
    RED_GEM_CUP = 100,
    GREEN_GEM_CUP = 101,
...
// Checked 105, it's a Gem Cup called "Ripper Roo's Challenge", that ultimately gives you the Skull Rock Purple CTR Token.
...
static int rando_database[] = {
    ...
    DB_PREFIX_LEVELIDS | RED_GEM_CUP,    RED_GEM_CUP,
    DB_PREFIX_LEVELIDS | GREEN_GEM_CUP,  GREEN_GEM_CUP,
    DB_PREFIX_LEVELIDS | BLUE_GEM_CUP,   BLUE_GEM_CUP,
    DB_PREFIX_LEVELIDS | YELLOW_GEM_CUP, YELLOW_GEM_CUP,
    DB_PREFIX_LEVELIDS | PURPLE_GEM_CUP, PURPLE_GEM_CUP,
    DB_RAMMARKER_END,
    DB_END
};
